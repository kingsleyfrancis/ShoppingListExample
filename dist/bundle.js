...
},{"./hasClass":2}],2:[function(require,module,exports){
"use strict";
...
},{"./checkPropTypes":20,"./lib/ReactPropTypesSecret":24,"_process":19,"object-assign":18}],23:[function(require,module,exports){
(function (process){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
...
},{"fbjs/lib/ExecutionEnvironment":4,"fbjs/lib/containsNode":7,"fbjs/lib/emptyFunction":8,"fbjs/lib/emptyObject":9,"fbjs/lib/getActiveElement":10,"fbjs/lib/invariant":13,"fbjs/lib/shallowEqual":16,"object-assign":18,"react":38}],27:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./Transition":31,"./utils/PropTypes":35,"_process":19,"dom-helpers/class/addClass":1,"dom-helpers/class/removeClass":3,"prop-types":23,"react":38}],30:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./TransitionGroup":32,"_process":19,"prop-types":23,"react":38,"react-dom":27}],31:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./utils/PropTypes":35,"_process":19,"prop-types":23,"react":38,"react-dom":27,"react-lifecycles-compat":28}],32:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./utils/ChildMapping":34,"_process":19,"prop-types":23,"react":38,"react-lifecycles-compat":28}],33:[function(require,module,exports){
'use strict';
...
},{"react":38}],35:[function(require,module,exports){
'use strict';
...
},{"prop-types":23}],36:[function(require,module,exports){
(function (process){
/** @license React v16.4.2
...
},{"_process":19,"fbjs/lib/emptyFunction":8,"fbjs/lib/emptyObject":9,"fbjs/lib/invariant":13,"fbjs/lib/warning":17,"object-assign":18,"prop-types/checkPropTypes":20}],37:[function(require,module,exports){
/** @license React v16.4.2
...
},{"fbjs/lib/emptyFunction":8,"fbjs/lib/emptyObject":9,"fbjs/lib/invariant":13,"object-assign":18}],38:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./cjs/react.development.js":36,"./cjs/react.production.min.js":37,"_process":19}],39:[function(require,module,exports){
"use strict";
...
var AnimatedShoppingList = function (_Component) {
    _inherits(AnimatedShoppingList, _Component);

    function AnimatedShoppingList() {
        _classCallCheck(this, AnimatedShoppingList);

        var _this = _possibleConstructorReturn(this, (AnimatedShoppingList.__proto__ || Object.getPrototypeOf(AnimatedShoppingList)).apply(this, arguments));

        _this.state = {
            items: [{ id: 1, name: 'Milk' }, { id: 2, name: 'Yogurt' }, { id: 3, name: 'Orange Juice' }],
            newItem: ""
        };
        return _this;
    }
    ...
    _createClass(AnimatedShoppingList, [{
        key: "handleChange",
        value: function handleChange(evt) {
            if (evt.key === 'Enter') {
                //Create a new item and set the current time as it's id
                var newItem = { id: Date.now(), name: evt.target.value };
        ...
        key: "changeInput",
        value: function changeInput(evt) {
        ...
        value: function render() {
            ...
            var shoppingItems = this.state.items.map(function (item, i) {
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        "div",
                        { className: "item", onClick: _this2.handleRemove.bind(_this2, i) },
                        item.name
                    )
                );
            });
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement("input", { type: "text", value: this.state.newItem,
...
exports.default = AnimatedShoppingList;


AnimatedShoppingList.propTypes = {
    items: _propTypes2.default.arrayOf(_propTypes2.default.object),
    newItem: _propTypes2.default.string
};
(0, _reactDom.render)(_react2.default.createElement(AnimatedShoppingList, null), document.getElementById("root"));

},{"prop-types":23,"react":38,"react-dom":27,"react-transition-group":33}]},{},[39]);
